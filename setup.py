...
setup(
    ...
    url='https://github.com/nlpia/nlpia_chat',
    author='Hobson Lane and others (See AUTHORS.md)',
    author_email='hobson+nlpia_chat@totalgood.com',
    ...
    keywords='django project package chat channels',  # Optional
